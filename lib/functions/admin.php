...
function user_profile_hide_script($hook)
{
    ...
    jQuery(function($) {
        ...
        $('#your-profile .user-nickname-wrap th').append('<div style="margin-top:5px">!!!変更しないでください!!!</div>');
        $('#your-profile .user-email-wrap th').append('<div style="margin-top:5px">!!!変更しないでください!!!</div>');
    });
    SCRIPT;
