...
<div class="w-100 text-center">
<a class="btn btn-primary text-center pl-5 pr-5" href="mailto:<?php echo $email; ?>"><img class="mr-2" src="<?php echo $wp_url; ?>/dist/images/icon_mail.svg" alt="メールアイコン">メールでお問い合わせ</a>
</div>
</div>
</div>
